...
export default function ExerciseScheduleDetailsPage() {
  ...
  return (
    <DashboardLayout
      title={isRtl ? schedule.nameAr || schedule.nameEn : schedule.nameEn}
    ...
    >
      <div className="space-y-6 pb-6">
        ...
        <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-5">
          <div className="flex items-start gap-4 min-w-0">
            <Link
              ...
              className="mt-1 p-2.5 rounded-xl border transition-colors flex-shrink-0 hover:border-[#cafd00] hover:text-[#cafd00]"
            ...
            <div className="min-w-0 space-y-1.5">
              ...
              <p className="text-base font-medium" style={{ color: "#8a8888" }} dir="rtl" lang="ar">
                {schedule.nameAr}
              </p>
        ...
        <div className="grid grid-cols-2 lg:grid-cols-5 gap-3">
          ...
          >
            <div
              className="p-2 rounded-xl flex-shrink-0"
              style={{ background: "rgba(173,170,170,0.1)", color: "#adaaaa" }}
            >
        ...
        {sortedDays.length === 0 ? (
          ...
          >
            ...
            >
              <CalendarDays className="w-7 h-7" style={{ color: "#cafd00", opacity: 0.4 }} />
            </div>
            <p className="text-sm mb-4" style={{ color: "#8a8888" }}>
              ...
              return (
                ...
                >
                  ...
                  <button
                    ...
                    className="w-full flex items-center justify-between gap-4 px-5 py-4 text-left transition-colors hover:bg-[#1a1a1a]"
                  >
                    <div className="flex items-center gap-4 min-w-0">
                      ...
                      <div className="min-w-0">
                        ...
                        >
                          ...
                          <span className="mx-1.5" style={{ color: "#2a2a2a" }}>
                            ·
                          </span>
                    ...
                    <div
                      ...
                      style={{
                        background: isExpanded ? "rgba(202,253,0,0.1)" : "transparent",
                        color: isExpanded ? "#cafd00" : "#8a8888",
                      }}
                    >
                      {isExpanded ? (
                  ...
                  {/* Exercises */}
                  {isExpanded && (
                    <div className="border-t" style={{ borderColor: "#20201f" }}>
                      {day.descriptionEn && (
                        <p
                      ...
                      {day.exercises.length === 0 ? (
                        ...
                        <div className="overflow-x-auto">
                          <table className="w-full min-w-[680px]">
                            <thead>
                              <tr className="border-b" style={{ borderColor: "#20201f" }}>
                                <th
                            ...
                            <tbody>
                              {[...day.exercises]
                                ...
                                .map((ex, exIdx) => (
                                  <tr
                                    key={ex.id}
                                    className="border-b transition-colors hover:bg-[#1a1a1a]"
                                  ...
                                  >
                                    ...
                                    <td
                                      ...
                                      style={{ color: ex.notes ? "#adaaaa" : "#8a8888" }}
                                    >
                                ...
                                <td colSpan={4} className="px-5 py-3">
                                  ...
                                  >
                                    <span className="flex items-center gap-1.5">
                                      <Dumbbell className="w-3 h-3" style={{ color: "#cafd00" }} />
                                      {day.exercises.length} {t.exerciseSchedules.exercises}
                                    </span>
                                    <span style={{ color: "#2a2a2a" }}>·</span>
                                    <span className="flex items-center gap-1.5">
                                      <BarChart3 className="w-3 h-3" style={{ color: "#cafd00" }} />
                                      {totalSets} {t.exerciseSchedules.sets}
                                    </span>
                                  </div>
                                </td>
      ...
      >
        <p className="text-sm" style={{ color: "#adaaaa" }}>
          <span style={{ color: "#ffffff", fontWeight: 600 }}>{schedule.nameEn}</span>
        </p>
